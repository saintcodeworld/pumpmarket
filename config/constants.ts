...
export const CONFIG = {
  ...
  SRX402_MINT: '79xM58VGFSyCKxZ7E4hJk6vtmab6MfRUiFqgjihHpump',
  // DexScreener chart for $PumpMarket token (used in TokenGateModal and home page)
  SRX402_DEXSCREENER_URL: process.env.NEXT_PUBLIC_SRX402_DEXSCREENER_URL || 'https://dexscreener.com/solana/79xM58VGFSyCKxZ7E4hJk6vtmab6MfRUiFqgjihHpump',
